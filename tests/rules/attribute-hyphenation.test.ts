...
ruleTester.run('attribute-hyphenation', rule, {
  ...
  invalid: [
    ...
    },
    {
      ...
      output: '<template lang="pug">div: custom(v-bind:myProp="prop")</template>',
      options: ['never'],
      errors: [
        {
    ...
    },
    {
      ...
      output: '<template lang="pug">div: custom(v-bind:my-prop="prop")</template>',
      options: ['always'],
      errors: [
        {
    ...
    },
    {
      ...
      output: '<template lang="pug">div: custom(v-bind:my-prop="prop" :secondProp="test")</template>',
    ...
    },
    {
      ...
      output: '<template lang="pug">div: custom(v-bind:prop-i-d="prop" :secondPropID="test")</template>',

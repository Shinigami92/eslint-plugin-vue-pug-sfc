// Onetime generated from https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/no-template-key.js
...
const rule: Rule.RuleModule = vuePlugin.rules['no-template-key']!;

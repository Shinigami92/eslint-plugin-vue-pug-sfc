// Onetime generated from https://github.com/vuejs/eslint-plugin-vue/blob/8f094200664a2b10bc597016f5486066a174e098/tests/lib/rules/valid-v-else-if.js
...
const rule: Rule.RuleModule = vuePlugin.rules['valid-v-else-if']!;
